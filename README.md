...
# Attribution & License 
Copyright (C) 2025-2026 Max Morris.

FukaGateway is licensed under the GNU Affero General Public License version 3 (AGPLv3).

If you use FukaGateway in your research, please cite the paper (to be added later).
